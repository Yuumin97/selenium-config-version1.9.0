...
import ducmin.com.exceptions.FrameworkException;
import ducmin.com.exceptions.InvalidPathForExtentReportFileException;
...
public final class ReportUtils {
    ...
    public static String createExtentReportPath() {
        ...
        if (FrameworkConstants.OVERRIDE_REPORTS.trim().equals(FrameworkConstants.NO)) {
            ...
            link = FrameworkConstants.EXTENT_REPORT_FOLDER_PATH + "/" + DateUtils.getCurrentDate() + "_"
                    + FrameworkConstants.EXTENT_REPORT_FILE_NAME;
            System.out.println("Created link report: " + link);
            return link;
        } else {
            link = FrameworkConstants.EXTENT_REPORT_FOLDER_PATH + "/" + FrameworkConstants.EXTENT_REPORT_FILE_NAME;
            System.out.println("Created link report: " + link);
            return link;
        }
    }

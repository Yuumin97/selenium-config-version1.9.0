...
import ducmin.com.utils.DateUtils;
import ducmin.com.utils.IconUtils;
import ducmin.com.utils.ReportUtils;
    ...
    public static void initReports() {
        if (Objects.isNull(extentReports)) {
            ...
            if (FrameworkConstants.OVERRIDE_REPORTS.trim().equals(FrameworkConstants.NO)) {
                ...
                link = FrameworkConstants.EXTENT_REPORT_FOLDER_PATH + "/" + DateUtils.getCurrentDateTimeCustom("_") + "_" + FrameworkConstants.EXTENT_REPORT_FILE_NAME;
